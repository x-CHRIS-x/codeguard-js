# Phase 00: Agree on workload and timeline
...
These rough effort ranges are planning assumptions, not measured estimates. Replace them after checking availability and the first technical phase.
...
Keep the four corrections, meaningful sample labels, a checkable evaluator, required lab evidence, and the professor's format. Reduce extras first: no dashboard redesign, full taint-analysis engine, dependency-audit service, elaborate reporting framework, or additional scenario collection.

Use the existing scanners and report data wherever possible. If required testing still cannot be completed, document the constraint and resolve any unfulfilled research promise under the professor's advisory. Do not substitute invented results or rename a local run as an AU lab test.

## Done and stop

- [ ] All four members have reviewed the workload.
- [ ] Owners, reviewers, and available dates are recorded.
- [ ] Lab access and the number of PCs have been resolved or assigned for follow-up.
- [ ] The group has selected the next small batch.

Stop with the agreed schedule. Group discussion and lab booking remain human tasks; creating this guide does not mean anyone has already been contacted.
