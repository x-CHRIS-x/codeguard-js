...
The expected result is 24 active base checks in 8 modules across A01, A02, A03, A05, A06, A07, and A08. Count from active rule registration, not guidance-catalog entries. `auth.js` contains both A02 and A07 checks, while two modules map to A03.
